...
async sub load_users_verification_codes_pkey_p($self, $companies_pkey, $users_pkey, $users_verification_codes_pkey) {
    return $self->load_users_verification_codes_pkey($companies_pkey, $users_pkey, $users_verification_codes_pkey);
}

sub load_users_verification_codes_pkey($self, $companies_pkey, $users_pkey, $users_verification_codes_pkey) {
    return $self->load_pk(
