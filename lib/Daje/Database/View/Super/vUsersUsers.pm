...
has 'fields' => '"users_users_pkey", "editnum", "insby", "insdatetime", "modby", "moddatetime","users_workflow_fkey","avatar","mail","password","name","active","comment","position","biography","authorities_role_fkey","phone","department","employed","verified"';
