...
"users_workflow_fkey","avatar","mail","password","name","active","comment","position","biography",
...
has 'mandatory' => 'users_workflow_fkey,mail,password,active,authorities_role_fkey,languages_lan_fkey,employed,verified,';
