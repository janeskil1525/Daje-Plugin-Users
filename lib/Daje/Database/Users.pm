...
-- Last generated 2026-02-01 16:28:11
...
CREATE OR REPLACE VIEW v_users_verification_codes AS
    SELECT users_verification_codes_pkey, editnum, insby, insdatetime, modby, moddatetime,users_users_fkey,
      verification_code
...
CREATE OR REPLACE VIEW v_users_verification_codes_list AS
    SELECT users_verification_codes_pkey, editnum, insby, insdatetime, modby, moddatetime,users_users_fkey, verification_code     FROM users_verification_codes;
