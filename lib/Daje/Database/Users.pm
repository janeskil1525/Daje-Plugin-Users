...
-- Last generated 2026-04-06 10:45:24
    ...
    moddatetime timestamp without time zone NOT NULL DEFAULT now(),
            users_workflow_fkey BIGINT  NOT NULL, -- This users workflow
                    ...
                    languages_lan_fkey BIGINT  NOT NULL, -- Users preferred language
                        ...
                        avatarurl  VARCHAR  NOT NULL DEFAULT '' , -- Avatar url
                        sendinvitation  BOOLEAN  NOT NULL DEFAULT false , -- sendinvitation
                        addressline2  VARCHAR  NOT NULL DEFAULT '' , -- Address Line 2
                        officelocation  VARCHAR  NOT NULL DEFAULT '' , -- Officelocation
                        notes  VARCHAR  NOT NULL DEFAULT '' , -- Notes
...
CREATE OR REPLACE VIEW v_users_users_list AS -- 
    SELECT users_users_pkey, editnum, insby, insdatetime, modby, moddatetime,users_workflow_fkey, password, active, avatar, mail, name, comment, biography, phone, department, employed,      (SELECT iso_code FROM languages_lan WHERE languages_lan_pkey = languages_lan_fkey) as languages_lan_iso_code,languages_lan_fkey, verified, country, city, zipcode, addressline1, region, avatarurl, sendinvitation, addressline2, officelocation, notes     FROM users_users;
...
CREATE OR REPLACE VIEW v_users_documentation_list AS -- 
    SELECT users_documentation_pkey, editnum, insby, insdatetime, modby, moddatetime, document_name,users_users_fkey, document_type, document     FROM users_documentation;
